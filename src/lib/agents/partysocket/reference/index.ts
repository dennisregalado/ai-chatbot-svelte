...
import type * as RWS from 'partysocket/ws';

type Maybe<T> = T | null | undefined;
type Params = Record<string, Maybe<string>>;
const valueIsNotNil = <T>(keyValuePair: [string, Maybe<T>]): keyValuePair is [string, T] =>
...
export default class PartySocket extends ReconnectingWebSocket {
	...
	public reconnect(code?: number | undefined, reason?: string | undefined): void {
	...
	static async fetch(options: PartyFetchOptions, init?: RequestInit): Promise<Response> {
