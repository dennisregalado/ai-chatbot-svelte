...
>
	...
	<Field.Description class="absolute bottom-6 px-6 text-center text-xs text-balance">
		By continuing, you acknowledge & agree to the <a href="/terms">Terms of Service</a>
		and
...
{#snippet socialProviders()}
	<Field.Field class="flex flex-col gap-2">
		...
		>
			<svg aria-hidden="true" role="graphics-symbol" viewBox="3.68 2.37 15.23 17.3" class="size-4"
				><path
					fill="currentColor"
